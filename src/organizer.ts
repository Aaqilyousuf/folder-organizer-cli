// import fs, { close, closeSync } from "fs";
...
// export function organizeFolder(folderPath: string) {
...
//     const ext = path.extname(file).slice(1).toLocaleLowerCase();
...
//     console.log(chalk.green(`✅ Moved ${file} → ${targetFolder}/`));
//   }
//   console.log(chalk.blue("🎉 Folder organized successfully!"));
// }
import fs from "fs";
import path from "path";
import chalk from "chalk";
